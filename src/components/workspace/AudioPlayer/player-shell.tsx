...
import { AudioScrubber } from "@/components/kit/waveform";
import { Button } from "@/components/kit/button";

import { formatTime } from "@/lib/format";
import { AudioPlayerCollectionMenu } from "@/components/workspace/AudioPlayer/collection-menu";
import { AudioPlayerFavoriteButton } from "@/components/workspace/AudioPlayer/favorite-button";
import type { AudioPlayerFileRecord } from "@/components/AudioPlayer/types";
import { AudioPlayerVolumeControl } from "@/components/workspace/AudioPlayer/volume-control";
...
export function AudioPlayerShell({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 flex justify-center px-4">
      <div className="pointer-events-auto w-full max-w-3xl rounded-xl border border-edge-hover bg-[#101014]/95 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_16px_44px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
        <div className="flex items-center gap-3">
          <div className="flex shrink-0 items-center gap-1.5">
            ...
            <Button
              ...
              className="size-11 shrink-0 rounded-full border-edge-accent bg-[image:var(--mat-accent-hover)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_0_24px_color-mix(in_oklab,var(--accent-fill)_45%,transparent)] hover:bg-[image:var(--mat-accent-hover)] hover:brightness-110"
