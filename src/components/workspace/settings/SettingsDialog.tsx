...
import type { SettingsDialogProps, SettingsDialogBodyProps } from "@/components/settings/types";

import { Database, ListMusic, FolderOpen, Layers, Monitor, Info, SlidersHorizontal } from "lucide-react";

import { Dialog, DialogContent as BaseDialogContent, DialogTitle } from "@/components/kit/dialog";

import { Separator } from "@/components/kit/separator";
import { Tabs, TabsList, TabsTrigger } from "@/components/kit/tabs";

import { DotmSquare3 } from "@/components/kit/dotm-square-3";
import { ScrollArea } from "@/components/kit/scroll-area";

import { LibraryTab } from "@/components/workspace/settings/library-tab";
import { MetadataTab } from "@/components/workspace/settings/metadata-tab";
import { ExtensionsTab } from "@/components/workspace/settings/extensions-tab";
import { AppearanceTab } from "@/components/workspace/settings/appearance-tab";
import { ShortcutsTab } from "@/components/workspace/settings/shortcuts-tab";
import { AboutTab, APP_VERSION } from "@/components/workspace/settings/about-tab";
