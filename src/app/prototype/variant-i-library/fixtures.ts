// PROTOTYPE ONLY — fixtures for the `/prototype/variant-i-library` comparison
// specimen. Route-local: the library must not import from prototype sources.
...
export const SPECIMEN_SETTINGS: Array<{
  key: string;
  label: string;
  description: string;
  disabled?: boolean;
