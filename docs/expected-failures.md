...
- B08 — extension-host-transport: null envelope escapes the handler (#138)
- E01 — extension-host-transport: unenforced extension grants, host level (#138)
...
- B01 — data-loss-prevention: gather overwrites user audio (#136)
...
- B05 — scanner: header-only first parse (#139)
