...
export const FileTableDirectoryRow = memo(function FileTableDirectoryRow({
  ...
  const row = (
    <div
      className={`group absolute left-0 top-0 grid w-full cursor-pointer items-center gap-3 border-b border-edge px-3 outline-none transition-[background-color,color] last:border-0 hover:bg-white/[0.04] ${
        desktop
