...
export function PaletteDesigns() {
  ...
  return (
    <div className="space-y-4">
      ...
      <VariantFrame id="P-F" name="Revised quiet (implement spec)" note="Exact proposal: quiet rows, soft orange glow, transparent shell. No tiles, no sections.">
        <div className="mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-shell/90 shadow-glow-accent backdrop-blur-2xl">
          <div className="flex items-center gap-3 border-b border-white/10 px-5">
            <Search className="size-4 shrink-0 text-zinc-500" />
            <input
              placeholder="Type a command or sound..."
